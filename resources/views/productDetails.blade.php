                    ...
                    <div class="col-md-9 single-grid">
                        <div clas="single-top">
                                ...
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="images/si.jpg">
                                            <div class="thumb-image"> <img src="{{asset($singleProduct->product_image)}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">{{$singleProduct->product_price}}</p>
                                <div class="description">
                                    <p><span>Quick Overview : </span>{{$singleProduct->product_long_description}}</p>
                                </div>
                                ...
                                <div class="women">
                                    <span class="btn btn-info">{{$singleProduct->product_qty}}</span>
                                    <span class="btn btn-warning">{{$singleProduct->status='active'?'Stock':'No-Stock'}}  </span>

                                    <span class="size">{{$singleProduct->category_name}} </span>
                    ...
                    <div class="col-md-3 single-grid1">
                        ...
                        <div class="recent-grids">
                            <div class="recent-left">
                                <a href="single.html"><img class="img-responsive " src="{{asset($singleProduct->product_image)}}" alt=""></a>
                            </div>
