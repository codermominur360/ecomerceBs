                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="{{url('category')}}" class="act">Home</a></li>
                                <!-- Mega Menu -->
                                <li class="dropdown">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    @foreach($category_display as $category_ds)
                                                        <li><a href="{{url('ctg_By_cont/'.$category_ds->category_id)}}">{{ $category_ds->category_name }}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
